...
//float EREST_ACT = -0.055 // Lower EREST_ACT to shift channel kinetics. This will make it so that the cell doesn't
			 // start firing spontaneously at -60mV
...
// elements
	// Build CA3
	float old_EREST = -0.060	// Optionally alter membrane leak potential
	...
	float new_EREST = -0.060
	//EREST_ACT = {new_EREST}
	readcell fbsyn_traub96_no_proximalAMPA.p {fb_cell_name}
	//EREST_ACT = {old_EREST}
