...
int fb_nx = 2 // number of feedback interneurons along x-axis
int fb_ny = 1 // 3 number of feedback interneurons along y-axis
...
int ff_nx = 1 // number of feedforward interneurons along x-axis
int ff_ny = 1 // 3 number of feedforward interneurons along y-axis
...
int aff_nx = 8 // number of randomspike elements along x-axis
...
float aff2ff_AMPA_targets = 16 // level 7-9	// originally 16 should be 18
...
float fb2fb_GABA_A_targets = 10 // level 3-5	//originally 6 should be 10
float n_fb2fb_GABA_A = 35
float p_fb2fb_GABA_A = {n_fb2fb_GABA_A}/({n_of_fb}*{fb2fb_GABA_A_targets})


float aff2fb_GABA_A_targets = 7 // level 7-9	// there are 8
float n_aff2fb_GABA_A = 35 // Same as Menne's fb2pyr value (35)
//float n_aff2fb_GABA_A = 95 // Used in Traub 1996
float p_aff2fb_GABA_A = {n_aff2fb_GABA_A}/({n_of_aff}*{aff2fb_GABA_A_targets})


float aff2fb_GABA_B_targets = 20 // level 9 only  // this used to be 6
//float n_aff2fb_GABA_B = 12 // Taken from Traub 1996, # GABA_B = 10
float n_aff2fb_GABA_B = 24	 // (The random number generator reduces this to 10)
float p_aff2fb_GABA_B = {n_aff2fb_GABA_B}/({n_of_aff}*{aff2fb_GABA_B_targets})


float aff2fb_AMPA_targets = 27 // level 7-9	// this used to be 18
float n_aff2fb_AMPA = 30 // Traub 96 uses 32
float p_aff2fb_AMPA = {n_aff2fb_AMPA}/({n_of_aff}*{aff2fb_AMPA_targets})


float p_aff2fb_NMDA = {p_aff2fb_AMPA}

//float p_aff2fb_AMPA = 1

//=================================================================
// transmitter baseline concentration	//daveadd
//=================================================================

float peak_conc = 1e-3	// peak transmitter concentration
float base_conc_int = 0//0.000005e0	// baseline transmitter concentration
float base_conc_pyr = 0
float conc_width = 0.001


	//To emulate only baseline levels...
//float peak_conc = 0e-3	// peak transmitter concentration
float ss_m60 = 1.2356e-8 // Steady state value at corresponding voltage (-60mV)
float ss_m50 = 9.1295e-8
float ss_m45 = 2.4820e-7 	// 2.4820e-7 Corresponds to pre-synaptic voltage of -45mV
float ss_m40 = 6.7445e-7
float ss_m35 = 1.8326e-6

float base_conc_int = {ss_m45}
float base_conc_pyr = {ss_m60}
...
//daveadd
rand_from_aff_weight = 0.05
float rand_from_aff_NMDA_weight = 0.25
...
float aff_rate = 0.25 // daveadd

//float default_aff_rate = 0.35
//float exc_aff_rate = 0.35 // daveadd
//float int_aff_rate = 0.35 // daveadd
