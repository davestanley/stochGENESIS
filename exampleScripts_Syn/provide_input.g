...
volumeconnect {aff_input_array_name}{aff_input_name}[] \
	      {pyr_array_name}{pyr_cell_name}[]/bas3_#/AMPA,{pyr_array_name}{pyr_cell_name}[]/ap5_#/AMPA,{pyr_array_name}{pyr_cell_name}[]/ap6_#/AMPA \
 	      -relative \
...
volumeconnect {aff_input_array_name}{aff_input_name}[] \
	      {pyr_array_name}{pyr_cell_name}[]/bas3_#/NMDA,{pyr_array_name}{pyr_cell_name}[]/ap5_#/NMDA,{pyr_array_name}{pyr_cell_name}[]/ap6_#/NMDA \
 	      -relative \
	      -sourcemask box -1 -1 -1 1 1 1 \ // all afferents 
	      -destmask box \
		{aff2pyr_x1} {aff2pyr_y1} {aff2pyr_z1} \
