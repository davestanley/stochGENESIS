...
float n_aff2fb_GABA_A = 96 // Same as Menne's fb2pyr value
//float n_aff2fb_GABA_A = 95 // Used in Traub 1996
float p_aff2fb_GABA_A = {n_aff2fb_GABA_A}/({n_of_aff}*{aff2fb_GABA_A_targets})


float aff2fb_GABA_B_targets = 6 // level 9 only  // this used to be 6
float n_aff2fb_GABA_B = 12 // Taken from Traub 1996, # GABA_B = 10
//float n_aff2fb_GABA_B = 20 // We will use 20
float p_aff2fb_GABA_B = {n_aff2fb_GABA_B}/({n_of_aff}*{aff2fb_GABA_B_targets})


float aff2fb_AMPA_targets = 24 // level 7-9	// this used to be 18
float n_aff2fb_AMPA = 32 // let's aim for one per compartment
...
float base_conc_int = 2.4820e-7	// 2.4820e-7 Corresponds to pre-synaptic voltage of -45mV
float base_conc_pyr = 9.1295e-8	// 9.1295e-8 Corresponds to pre-synaptic voltage of -50mV
