...
function make_K_DR_m
        ...
        create GENvgpores K_DR_m
                ...
                setfield ^ Ek {pyr_EK} Ik 0 Gk 0 Nt 10 Gmax {20.0*{onepS}}
...
function make_K_DRi_m
        ...
        create GENvgpores K_DRi_m
                ...
                setfield ^ Ek {int_EK} Ik 0 Gk 0 Nt 10 Gmax {20.0*{onepS}}
...
function make_Ca_m
        ...
        create GENvgpores Ca_m
                ...
                setfield ^ Ek {ECA} Ik 0 Gk 0 Nt 10 Gmax {20.0*{onepS}}
...
function make_K_C_m (location)
	...
	if (location == "1"); str KCname = "K_C"
		...
		if ((location == "1") || (location == "2"))
	                setfield ^ Ek {pyr_EK} Nt 10 Gmax {20.0*{onepS}} Ik 0 Gk 0
		elif ((location == "3") || (location == "4"))
	                setfield ^ Ek {int_EK} Nt 10 Gmax {20.0*{onepS}} Ik 0 Gk 0
		end
...
function make_K_AHP_m (location)
	...
	if (location == "1"); str KAHPname = "K_AHP"
        ...
        create GENtabchan {KAHPname}_m
                ...
                //      S
		if ((location == "1") || (location == "2"))
	                setfield ^ Ek {pyr_EK} Nt 10 Gmax {20.0*{onepS}} Ik 0 Gk 0 num_Xgate 1
		elif ((location == "3") || (location == "4"))
	                setfield ^ Ek {int_EK} Nt 10 Gmax {20.0*{onepS}} Ik 0 Gk 0 num_Xgate 1
		end
...
float Rc = 73.8
	...
	//Create Channel
	create GENsynpores GABA_B_m
	setfield GABA_B_m Ek {E_GABAB} Nt 10 Gmax {45*{onepS}} Trans 9.3e-6 \
				TCoef1 {Rb} TCoef2 {Rb} S12_S11 {Ru} S13_S12 {Ru} \
				S13_S23 {Rr} S23_S13 {Rd} S13_S14 {Ro} S14_S13 {Rc} \
				openstate1 14
