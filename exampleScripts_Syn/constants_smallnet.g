...
float aff2fb_GABA_A_targets = 7 // level 7-9	// three are 8
float n_aff2fb_GABA_A = 35 // Same as Menne's fb2pyr value
//float n_aff2fb_GABA_A = 95 // Used in Traub 1996
float p_aff2fb_GABA_A = {n_aff2fb_GABA_A}/({n_of_aff}*{aff2fb_GABA_A_targets})


float aff2fb_GABA_B_targets = 6 // level 9 only  // there are 6
//float n_aff2fb_GABA_B = 10 // Taken from Traub 1996, # GABA_B = 10
float n_aff2fb_GABA_B = 20 // We will use 20
float p_aff2fb_GABA_B = {n_aff2fb_GABA_B}/({n_of_aff}*{aff2fb_GABA_B_targets})


float aff2fb_AMPA_targets = 18 // level 7-9	// three are 8
float n_aff2fb_AMPA = 20 // let's aim for one per compartment
