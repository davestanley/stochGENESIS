...
volumeconnect {pyr_array_name}{pyr_cell_name}[]/ax/pyr_spikegen \
	      {pyr_array_name}{pyr_cell_name}[]/ap8_#/AMPA,{pyr_array_name}{pyr_cell_name}[]/ap9_#/AMPA,{pyr_array_name}{pyr_cell_name}[]/ap10_#/AMPA,{pyr_array_name}{pyr_cell_name}[]/bas2_#/AMPA \
	      -relative \
...
volumeconnect {pyr_array_name}{pyr_cell_name}[]/ax/pyr_spikegen \
	      {pyr_array_name}{pyr_cell_name}[]/ap8_#/NMDA,{pyr_array_name}{pyr_cell_name}[]/ap9_#/NMDA,{pyr_array_name}{pyr_cell_name}[]/ap10_#/NMDA,{pyr_array_name}{pyr_cell_name}[]/bas2_#/NMDA \
	      -relative \
	      -sourcemask box -1 -1 -1 1 1 1 \ // all pyramidal cells 
	      -destmask box \
		{pyr2pyr_x1} {pyr2pyr_y1} {pyr2pyr_z1} \
...
volumeconnect {fb_array_name}{fb_cell_name}[]/ax/spikegen \
	      {pyr_array_name}{pyr_cell_name}[]/bas3_#/GABA_A,{pyr_array_name}{pyr_cell_name}[]/soma/GABA_A,{pyr_array_name}{pyr_cell_name}[]/ap5#/GABA_A \
	      -relative \
	      -sourcemask box -1 -1 -1 1 1 1 \ // all pyramidal cells 
	      -destmask ellipsoid \
...
volumeconnect {ff_array_name}{ff_cell_name}[]/ax/spikegen \
	      {pyr_array_name}{pyr_cell_name}[]/ap10_#/GABA_B \
	      -relative \
	      -sourcemask box -1 -1 -1 1 1 1 \ // all pyramidal cells 
	      -destmask ellipsoid \
