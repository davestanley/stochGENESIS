...
addmsg {wrsource} {wrdiffampname} PLUS Vm
...
function save_file_Im (wrdest_save, wrsource)
...
addmsg {wrsource}/../soma {wrdest_save} SAVE Im
addmsg {wrsource}/../soma {wrdest_save} SAVE inject
