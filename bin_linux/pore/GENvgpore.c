...
/*GENvgpore.c contains the defining action function*/
...
#define Ss(field) GENvgpore->field

void GENvgPorePop(GENvgpore, action)

struct   GENvg_pore_type *GENvgpore;
Action   *action; 

{
	...
	if (debug > 1)
		ActionHeader("GENvgporePop", GENvgpore, action);
