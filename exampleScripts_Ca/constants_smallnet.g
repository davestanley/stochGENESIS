...
float aff2fb_GABA_A_targets = 8 // level 7-9	// three are 8
...
float peak_conc = 5e0	// peak transmitter concentration
float base_conc = 0//0.000005e0	// baseline transmitter concentration
