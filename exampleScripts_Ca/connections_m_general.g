...
function markov_synapse (source, dest)
	...
	if ( {exists {curr_markov}} )
		...
		if ( {originalchannel} == "AMPA" || {originalchannel} == "GABA_A" || {originalchannel} == "NMDA" || {originalchannel} == "GABA_B")
			...
			if( {originalchannel} == "AMPA" ); setfield {new_channel} Nt {round {{getfield {new_channel} Nt} * 2000/2780}}; end
			if( {originalchannel} == "NMDA" ); setfield {new_channel} Nt {round {{getfield {new_channel} Nt} * 2000/750}}; end
			if( {originalchannel} == "GABA_A" ); setfield {new_channel} Nt {round {{getfield {new_channel} Nt} * 2000/1462}}; end
			if( {originalchannel} == "GABA_B" )
				if ( {getfield {new_channel} mode} == "regular" )
					...
					// Gprotein max
					setfield {new_channel}/G_protein Gbar {{getfield {dest} gmax} * 2000/100} Nt 0
					// K_pore max
					if ( {getfield {new_channel} k_pore_mode} == 1 )
						setfield {new_channel}/K_pore Nt {round {{{getfield {dest} gmax} / \
							{getfield {new_channel}/K_pore Gmax}} * 100}}
					else
						setfield {new_channel}/K_pore Nt {round {{{getfield {dest} gmax} / \
						...
						// and that the total "value" of the receptors is one
					setfield {new_channel} Nt 10000
					setfield {new_channel} Gmax { 1/{getfield {new_channel} Nt} }

				else	// Inverted NMDA
					setfield {new_channel} Nt {round {{getfield {new_channel} Nt} * 2000/500}};
				end
			end
...
volumeconnect_general {aff_input_array_name}{aff_input_name}[] \
	...
	// Randomize weights
//	volumeweight_general {aff_input_array_name}{aff_input_name}[] \
//	      {dest_int_array_name}{dest_int_cell_name}[]/ap7_#/AMPA,{dest_int_array_name}{dest_int_cell_name}[]/ap8_#/AMPA,{dest_int_array_name}{dest_int_cell_name}[]/ap9_#/AMPA \
//		1.0 0.15
...
randseed 54321
volumeconnect_general {aff_input_array_name}{aff_input_name}[] \
		{dest_int_array_name}{dest_int_cell_name}[]/bas1_#/AMPA,{dest_int_array_name}{dest_int_cell_name}[]/bas2_#/AMPA,{dest_int_array_name}{dest_int_cell_name}[]/ap6_#/AMPA,{dest_int_array_name}{dest_int_cell_name}[]/ap7_#/AMPA,{dest_int_array_name}{dest_int_cell_name}[]/ap8_#/AMPA 1 \ //relative
			0 -1 -1 -1 1 1 1 \ // rectangular, all pyramidal cells 
...
randseed 54321
volumeconnect_general {aff_input_array_name}{aff_input_name}[] \
		{dest_int_array_name}{dest_int_cell_name}[]/bas1_#/NMDA,{dest_int_array_name}{dest_int_cell_name}[]/bas2_#/NMDA,{dest_int_array_name}{dest_int_cell_name}[]/ap6_#/NMDA,{dest_int_array_name}{dest_int_cell_name}[]/ap7_#/NMDA,{dest_int_array_name}{dest_int_cell_name}[]/ap8_#/NMDA 1 \ //relative
			0 -1 -1 -1 1 1 1 \ // rectangular, all pyramidal cells 
			0 {aff2ff_x1} {aff2ff_y1} {aff2ff_z1} \	//rectangular
			{aff2ff_x2} {aff2ff_y2} {aff2ff_z2} \
	...
	// Randomize weights
	volumeweight_general {aff_input_array_name}{aff_input_name}[] \
		{dest_int_array_name}{dest_int_cell_name}[]/bas1_#/AMPA,{dest_int_array_name}{dest_int_cell_name}[]/bas2_#/AMPA,{dest_int_array_name}{dest_int_cell_name}[]/ap6_#/AMPA,{dest_int_array_name}{dest_int_cell_name}[]/ap7_#/AMPA,{dest_int_array_name}{dest_int_cell_name}[]/ap8_#/AMPA	\
...
volumeconnect_general {aff_input_array_name}{aff_input_name}[] \
	      {dest_int_array_name}{dest_int_cell_name}[]/ap9#/GABA_B 1 \	//relative
...
volumeweight_general {aff_input_array_name}{aff_input_name}[] \
	      {dest_int_array_name}{dest_int_cell_name}[]/bas3#/GABA_A,{dest_int_array_name}{dest_int_cell_name}[]/soma/GABA_A,{dest_int_array_name}{dest_int_cell_name}[]/ap5_#/GABA_A \
		1.0 {rand_from_aff_weight}
